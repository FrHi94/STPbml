...
---
I have created the 'Doublet_removal' folder, which contains all necessary files 
for running this code. 
We can also store the outputs here. 
...
You can also find the seurat objects saved in the 'Doublet removal' folder, if
you would prefer to skip to that step directly. 
...
Putting the rownames of the dgCMatrix in the correct format.
(I am not sure this is necessary? I don't see much differences) 
...
We already have the annotation file ("mus_pb_annotation_seurat.tsv").
Here, we select only the annotations from the file that are not filled with NA.
...
```{r, Calculate new number of cells per sample}

cells_Sample12_after_filtering <- table(Idents(Sample12_seurat))
cells_Sample24_after_filtering <- table(Idents(Sample24_seurat))
cells_Sample38_after_filtering <- table(Idents(Sample38_seurat))
cells_Sample12C_after_filtering <- table(Idents(Sample12C_seurat))
cells_SampleNC2_after_filtering <- table(Idents(SampleNC2_seurat))
cells_Sample24C_after_filtering <- table(Idents(Sample24C_seurat))
cells_Sample38C_after_filtering <- table(Idents(Sample38C_seurat))

cells_Sample12_after_filtering
cells_Sample24_after_filtering
cells_Sample38_after_filtering
cells_Sample12C_after_filtering
cells_SampleNC2_after_filtering
cells_SampleNC2_after_filtering
cells_Sample24C_after_filtering
cells_Sample38C_after_filtering
...
I think the best pK value is 0.24
We expect ~7.6% of doublets
I have not been able to go past this step because of lack of memory
...
nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/seurat/
```{r, save seurat objects}
# As individual
saveRDS(nse_12, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_12_singlets.RDS")

saveRDS(nse_24, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_24_singlets.RDS")

saveRDS(nse_38, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_38_singlets.RDS")

saveRDS(nse_12C, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_12C_singlets.RDS")

saveRDS(nse_NC2, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_NC2_singlets.RDS")

saveRDS(nse_24C, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_24C_singlets.RDS")

saveRDS(nse_38C, 
        file = "/home/st-analysis_home/franziska.hildebra/sn_Plasmodium/nucSeq_pb_liver_1222/Doublet_removal/Seurat_objects/Seurat_singlets/nse_38C_singlets.RDS")
