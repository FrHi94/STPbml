...
You can download the corresponding data from the zenodo repository and store them in the corresponding folder of the github repository
...
samples <- c(#12h-infected
             paste0(repo, "data/cnts/PB_12h/PB-12h/cnt/inf/CN29_C1_stdata.tsv.gz"),
             paste0(repo, "data/cnts/PB_12h/PB-12h/cnt/inf/CN29_D1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN57_12h_D1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN63_D1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN63_E1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN70_C1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN70_C2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/inf/CN71_C2_stdata.tsv.gz"), 
  #12h -control
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN29_C2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN29_D2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN63_D2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN63_E2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN70_D2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_12h/PB-12h/cnt/ctrl/CN71_D1_stdata.tsv.gz"),
  #24h -infected
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN31_24h_D1_stdata.tsv.gz"),  
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN31_24h_E1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN54_24h_C2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN54_24h_E1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN55_24h_C1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN55_24h_D1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/inf/CN55_24h_E1_stdata.tsv.gz"),
  #24h -control
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/ctrl/CN31_24h_cat_C2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/ctrl/CN31_E2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/ctrl/CN54_24h_D2_stdata.tsv.gz"),            
             paste0(repo,"data/cnts/PB_24h/PB-24h/cnt/ctrl/CN55_24h_C2_stdata.tsv.gz"),
  #38h -infected
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN50_C1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN50_C2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN50_D2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN51_38h_C1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN51_38h_D1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN53_38h_C1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN53_38h_D1_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/inf/CN53_38h_E1_stdata.tsv.gz"), 
  #38h -control
             paste0(repo,"data/cnts/PB_38h/cnts/ctrl/CN50_E1_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_38h/cnts/ctrl/CN50_E2_stdata.tsv.gz"),
             paste0(repo,"data/cnts/PB_38h/cnts/ctrl/CN51_38h_C2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/ctrl/CN51_38h_D2_stdata.tsv.gz"), 
             paste0(repo,"data/cnts/PB_38h/cnts/ctrl/CN53_38h_D2_stdata.tsv.gz")
             )
...
spotfiles <- c(paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN29_C1_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN29_D1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN57_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN63_D1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN63_E1_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN70_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN70_C2_0.1.tsv.gz"), 
              paste0(repo,"data/spots/PB_12h/PB-12h/spts/inf/spot_selection-CN71_C2_0.1.tsv.gz"),
              
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN29_C2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN29_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN63_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN63_E2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN70_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_12h/PB-12h/spts/ctrl/spot_selection-CN71_D1_0.1.tsv.gz"), 
              
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN31_D1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN31_E1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN54_C2_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN54_E1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN55_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN55_D1_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/inf/spot_selected-CN55_E1_0.1.tsv.gz"), 
              
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/ctrl/spot_selected-CN31_C2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/ctrl/spot_selected-CN31_E2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/ctrl/spot_selected-CN54_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_24h/PB-24h/spts/ctrl/spot_selected-CN55_C2_0.1.tsv.gz"), 
              
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN50_PBL_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN50_PBL_C2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN50_PBL_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN51_PBL_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN51_PBL_D1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN53_PBL_C1_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN53_PBL_D1_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_38h/spts/inf/spots_CN53_PBL_E1_0.1.tsv.gz"),
              
               paste0(repo,"data/spots/PB_38h/spts/ctrl/spots_CN50_PBL_E1_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_38h/spts/ctrl/spots_CN50_PBL_E2_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_38h/spts/ctrl/spots_CN51_PBL_C2_0.1.tsv.gz"),
               paste0(repo,"data/spots/PB_38h/spts/ctrl/spots_CN51_PBL_D2_0.1.tsv.gz"), 
               paste0(repo,"data/spots/PB_38h/spts/ctrl/spots_CN53_PBL_D2_0.1.tsv.gz")
                )
...
imgs <- c(paste0(repo,"data/imgs/HE/12h/inf/20210223_CN29_ST_12h_H_F_HE.C1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/inf/20210223_CN29_ST_12h_H_F_HE.D1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/inf/210412_CN57_PB_12h_HE_C1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/inf/210607_ST_200302_12h_CN63_HE_D1_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/12h/inf/210607_ST_200302_12h_CN63_E1_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/12h/inf/211010_CN70_J_RP_12h_C1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/inf/211010_CN70_12h_HE.C2_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/12h/inf/211010-CN71-K-C_C2_annotated_0.1.jpg"),
          
          paste0(repo,"data/imgs/HE/12h/ctrl/20210223_CN29_ST_12h_H_F_HE.C2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/ctrl/20210223_CN29_ST_12h_H_F_HE.D2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/ctrl/210607_ST_200302_G_RP_12h_CN63_HE_D2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/ctrl/210607_ST_200302_G_RP_12h_CN63_HE_E2_0.1.jpg"),
          paste0(repo,"data/imgs/HE/12h/ctrl/211010_CN70_12h_HE.D2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/12h/ctrl/211010-CN71_HE.D1_0.1.jpg"), 
          
          paste0(repo,"data/imgs/HE/24h/inf/20210222_CN31_ST_24h_J_F_HE_D1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/inf/20210222_CN31_ST_24h_J_F_HE_E1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/inf/CN54_24h_H.RP1_L_C2_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/inf/210327_CN54_24h_H.RP1_L_RP.2_HE.E1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/inf/210330_CN55_24h_G.RH.1_I.RH2_HE.C1_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/24h/inf/210330_CN55_24h_G.RH.1_I.RH2_HE.D1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/inf/210330_CN55_24h_G.RH.1_I.RH2_HE.E1_annotated_0.1.jpg"),
          
          paste0(repo,"data/imgs/HE/24h/ctrl/20210222_CN31_ST_24h_J_F_HE_C2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/ctrl/20210222_CN31_ST_24h_J_F_HE_E2_0.1.jpg"),
          paste0(repo,"data/imgs/HE/24h/ctrl/210327_CN54_24h_H.RP1_L_RP.2_HE.D2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/24h/ctrl/210330_CN55_24h_G.RH.1_I.RH2_HE.C2_0.1.jpg"),
          
          paste0(repo,"data/imgs/HE/38h/inf/CN50_PBL_HE_C1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/inf/CN50_PBL_HE_C2_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/inf/CN50_PBL_HE_D2_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/38h/inf/210326_CN51_Pb_G.1_I.2_HE_C1_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/38h/inf/210326_CN51_Pb_G.1_I.2_HE_D1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/inf/210326_CN53_Pb_G.C.1_I.C.2_HE_C1_annotated_0.1.jpg"),
          paste0(repo,"data/imgs/HE/38h/inf/210326_CN53_Pb_G.C.1_I.C.2_HE_D1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/inf/210326_CN53_Pb_G.C.1_I.C.2_HE_E1_annotated_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/ctrl/CN50_PBL_HE_E1_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/ctrl/CN50_PBL_HE_E2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/ctrl/210326_CN51_Pb_G.1_I.2_HE_C2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/ctrl/210326_CN51_Pb_G.1_I.2_HE_D2_0.1.jpg"), 
          paste0(repo,"data/imgs/HE/38h/ctrl/210326_CN53_Pb_G.C.1_I.C.2_HE_D2_0.1.jpg"))
```
...
mus.pb.annotation <- read.table(paste0(repo, "/data/annotations/mus_pb_annotation_seurat.tsv"), header = T, sep = "\t")
...
Next we would like to add a few additional covariates to the data, including the time of dissection which we would like to regress during the normalization and integration as well as the infection condition, slide numbers etc. 
...
Next we can add an additional column to the metadata that includes the 

```{r, annotate parasite positions based on distance to IF parasite annotation}
...
pb.annotation <- read.table(paste0(repo,"data/annotations/pb_annotation_seurat.tsv",header = T, sep = "\t"))
pb.mat <- as.matrix(se.pb@assays$RNA@counts)
pb.mat <- subset(pb.mat, rownames(pb.mat) %in% pb.annotation$gene_name)
pb.sum <- as.data.frame(colSums(pb.mat))
pb.sum <- subset(pb.sum, pb.sum > 0)
pb.sum$spot <- rownames(pb.sum)
hist(log10(pb.sum$`colSums(pb.mat)`))

infs <- c(1:8, 15,21, 26:12)
                                                
pb.sum$spot <- factor(pb.sum$spot,                                    
                  levels = pb.sum$spot[order(pb.sum$`colSums(pb.mat)`, decreasing = TRUE)])

ggplot(pb.sum, aes(spot,log10(`colSums(pb.mat)`))) + 
  geom_col()

pb.sum$log10 <- log10(pb.sum$`colSums(pb.mat)`)
pb.sum <- subset(pb.sum, pb.sum$log10 > 0)
pb.sum$log2 <- log2(pb.sum$`colSums(pb.mat)`)
...
se.pb$sample_id <- as.factor(se.pb$sample_id)

ids <- as.character(levels(se.pb$sample_id))
#get rownames for each samples and subset

sub <- lapply(ids, function(x){
subset(colnames(se.pb), se.pb$sample_id == x)
})
...
sums.inf <- subset(sums1, sums1$sample_id %in% infs)

 ggplot(sums.inf, aes(spot,colSums.pb.mat., fill=sample_id)) + 
  geom_col() + 
  ylab("Number of P. Berghei UMIs") 
 
sums.inf.l <- split(sums.inf, f = sums.inf$sample_id)  
#plot the spots and number of parasite transcripts for each sample

plot.l <- lapply(sums.inf.l, function (x){
 ggplot(x, aes(spot,colSums.pb.mat.)) + 
  geom_col() + 
  ylab("Number of P. Berghei UMIs")
})

library(ggpubr)
ggarrange(plotlist = plot.l, ncol = 4, nrow = 5, labels = infs)
...
png("PATH_TO_FOLDER", width = 20, height = 20, res = 300, units = "cm")
inf12h_p 
dev.off()
...
inf12h_p <- FeatureOverlay(se.pb,features = "nCount_pb",ncols = 2, sampleids = infs[16:23], pt.size = 1, pt.alpha = 0.6, custom.theme = theme(legend.title = element_blank(), plot.title = element_blank()), sample.label = F )

png("PATH_TO_FOLDER", width = 20, height = 20, res = 300, units = "cm")
inf12h_p 
dev.off()

png("PATH_TO_FOLDER", width = 40, height = 40, res = 300, units = "cm")
...
```{r, compare P.Berghei Count between conditions}
...
```{r, normalize the data and run prinicipal component analysis}
...
#png("res_R/DimPlot_clusters.png", res = 300,width = 20, height = 10, units = "cm")
DimPlot(se.pb, pt.size = 0.6) +
        theme(axis.ticks = element_blank(), axis.text = element_blank(), axis.title = element_blank(), reduction = "pca")
#dev.off()


#DimPlot(se.pb, group.by = "infection", reduction = "NMF")
...
#DimPlot(se.pb, group.by = "infection", reduction = "ica")
...
#ProjectDim(se.pb, reduction = "ica", dims= 1)

FeaturePlot(se.pb, reduction = "harmony", features = c("Saa2", "Saa1", "Glul", "Sds"))
#pb.genes <- rownames(se.pb@assays$SCT@counts)[grep(pattern = "-pb", x= rownames(se.pb@assays$SCT@counts))]
FeaturePlot(se.pb, reduction = "harmony", features = "HSP70-pb")
DimPlot(se.pb, group.by = "condition", reduction = "harmony")

#saveRDS(se.pb, "~/P.Berghei-Liver/object_se_pb_mus.RDS")

```



```{r, run umap, fig.height=12, fig.width=30, fig.height= 60}

clust.cols <- c("#1111cc", "#B23AEE","#fcca46", "#ae2012", "#A2CD5A", "#005f73", "#ee6123", "#62b6cb", "#ff0054", "#E9967A", "#76EEC6", "#00EE76")
ElbowPlot(se.pb, reduction = "harmony")

se.pb <- FindNeighbors(se.pb, dims = 1:20, reduction = "harmony", verbose = F)
se.pb <- FindClusters(se.pb, verbose = F, resolution = 0.4)
head(Idents(se.pb), 5)

se.pb <- RunUMAP(se.pb, dims = 1:20, reduction = "harmony", min.dist = 0.3, spread = 0.6)

#png("res_R/clusters_time_infection.png", width = 35, height = 20, res = 300, units = "cm")
DimPlot(se.pb, reduction = "umap", group.by = "seurat_clusters")
DimPlot(se.pb, reduction = "umap", group.by = "seurat_clusters", ncol = 6, split.by = "sample_id")
...
pdf("PATH_TO_FOLDER", width = 55, height = 15)
DimPlot(se.pb, reduction = "umap",
        cols = clust.cols, 
        group.by = "seurat_clusters", split.by = "condition", pt.size = 3) + 
  theme(axis.ticks = element_blank(), axis.text = element_blank(), axis.title = element_blank())
dev.off()

DimPlot(se.pb, reduction = "umap", group.by = "condition")
DimPlot(se.pb, reduction = "umap", group.by = "sample_id")
FeaturePlot(se.pb,
            reduction = "umap", 
            features = c("Glul","Sds", "Cyp2e1", "Cyp2f2", "Col1a1", "Dpt", "Saa1","Saa2", "Marco", "Clec4f", "Cd63", "HSP70-pb", "Dbp", "Usp2", "Tef", "Cyp2a4", "Cyp2a5", "Clock", "Arntl", "Npas2", "Cry2", "Hspa1b"))

FeaturePlot(se.pb,
            reduction = "umap", 
            features = c( "Decr2", "Usp2", "Marchf5", "Abcg5"))

ST.FeaturePlot(se.pb, features = "sample_id", ncol = 4)
ST.FeaturePlot(se.pb, features = "Decr2", ncol = 4)
ST.FeaturePlot(se.pb, features = "Usp2", ncol = 4)
ST.FeaturePlot(se.pb, features = "HSP90-pb", ncol = 4)
...
ST.FeaturePlot(se.pb, features = "Glul", ncol = 4, indices = 1, pt.size = 3)
ST.FeaturePlot(se.pb, features = "Sds", ncol = 4, indices = 1, pt.size = 3)

```

```{r, export cluster distributions across tissue sections}

#12h 
pdf("PATH_TO_FOLDER", width = 18, height =18)
ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 4,
                cols = clust.cols,
                pt.size = 2, indices = 1:14)
dev.off()
...
ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 4,
                cols = clust.cols,
                pt.size = 2, indices = 26:38)
dev.off()
```


```{r, find DEG between clusters}
...
##Run with only log-transformed data and compare: 

#DefaultAssay(se.pb) <- "RNA"
#se.pb <- se.pb %>%
#  NormalizeData() %>%
 # ScaleData() 

#deg.n
write.table(deg, "PATH_TO_FOLDER", quote = F,sep = ",", row.names = F, col.names = colnames(deg))
...
#top 10 genes
top10de <- deg %>% group_by(cluster) %>% top_n(n = 10, wt = avg_log2FC)
#top 5 genes
...
#set path to images to non-annotated images

imgs <- c(paste0(repo, "/HE/12h/20210223_CN29_ST_12h_H_F_HE.C1_0.1.jpg"), 
          paste0(repo, "/HE/12h/20210223_CN29_ST_12h_H_F_HE.D1_0.1.jpg"), 
          paste0(repo, "/HE/12h/210412_CN57_PB_12h_G-C_HE_C1_0.1.jpg"), 
          paste0(repo, "/HE/12h/210607_ST_200302_G_RP_12h_CN63_HE_D1_0.1.jpg"),
          paste0(repo, "/HE/12h/210607_ST_200302_G_RP_12h_CN63_HE_E1_0.1.jpg"),
          paste0(repo, "/HE/12h/211010_CN70_12h_HE.C1_0.1.jpg"), 
          paste0(repo, "/HE/12h/211010_CN70_12h_HE.C2_0.1.jpg"),
          paste0(repo, "/HE/12h/211010-CN71_HE.C2_0.1.jpg"),
          
          paste0(repo, "/HE/12h/ctrl/20210223_CN29_ST_12h_H_F_HE.C2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/20210223_CN29_ST_12h_H_F_HE.D2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/210607_ST_200302_G_RP_12h_CN63_HE_D2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/210607_ST_200302_G_RP_12h_CN63_HE_E2_0.1.jpg"),
          paste0(repo, "/HE/12h/ctrl/211010_CN70_12h_HE.D2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/211010-CN71_HE.D1_0.1.jpg"), 
          
          paste0(repo, "/HE/24h/20210222_CN31_ST_24h_J_F_HE_C1_0.1.jpg"), 
          paste0(repo, "/HE/24h/20210222_CN31_ST_24h_J_F_HE_E1_0.1.jpg"), 
          paste0(repo, "/HE/24h/210327_CN54_24h_H.RP1_L_RP.2_HE.C2_0.1.jpg"), 
          paste0(repo, "/HE/24h/210327_CN54_24h_H.RP1_L_RP.2_HE.E1_0.1.jpg"), 
          paste0(repo, "/HE/24h/210330_CN55_24h_G.RH.1_I.RH2_HE.C1_0.1.jpg"),
          paste0(repo, "/HE/24h/210330_CN55_24h_G.RH.1_I.RH2_HE.D1_0.1.jpg"), 
          paste0(repo, "/HE/24h/210330_CN55_24h_G.RH.1_I.RH2_HE.E1_0.1.jpg"),
          
          paste0(repo, "/HE/24h/ctrl/20210222_CN31_ST_24h_J_F_HE_C2_0.1.jpg"), 
          paste0(repo, "/HE/24h/ctrl/20210222_CN31_ST_24h_J_F_HE_E2_0.1.jpg"),
          paste0(repo, "/HE/24h/ctrl/210327_CN54_24h_H.RP1_L_RP.2_HE.D2_0.1.jpg"), 
          paste0(repo, "/HE/24h/ctrl/210330_CN55_24h_G.RH.1_I.RH2_HE.C2_0.1.jpg"),
          
          paste0(repo, "/HE/12h/CN50_PBL_HE_C1_0.1.jpg"), 
          paste0(repo, "/HE/12h/CN50_PBL_HE_C2_0.1.jpg"), 
          paste0(repo, "/HE/12h/CN50_PBL_HE_D1_0.1.jpg"),
          paste0(repo, "/HE/12h/210326_CN51_Pb_G.1_I.2_HE_C1_0.1.jpg"),
          paste0(repo, "/HE/12h/210326_CN51_Pb_G.1_I.2_HE_D1_0.1.jpg"), 
          paste0(repo, "/HE/12h/210326_CN53_Pb_G.C.1_I.C.2_HE_C1_0.1.jpg"),
          paste0(repo, "/HE/12h/210326_CN53_Pb_G.C.1_I.C.2_HE_D1_0.1.jpg"), 
          paste0(repo, "/HE/12h/210326_CN53_Pb_G.C.1_I.C.2_HE_E1_0.1.jpg"), 
          
          paste0(repo, "/HE/12h/ctrl/CN50_PBL_HE_E1_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/CN50_PBL_HE_E2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/210326_CN51_Pb_G.1_I.2_HE_C2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/210326_CN51_Pb_G.1_I.2_HE_D2_0.1.jpg"), 
          paste0(repo, "/HE/12h/ctrl/210326_CN53_Pb_G.C.1_I.C.2_HE_D2_0.1.jpg"))
...
se.pb <- LoadImages(se.pb, xdim = 2e3
                    )

se.pb <- MaskImages(se.pb)

#se.pb <- ManualAnnotation(se.pb) ##Run a Manual annotation if necessary 


ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = infs)
ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = sal)
ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = control) 

ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = infs,  spots = rownames(subset(se.pb[[]], seurat_clusters == c(4,8,2,3))))

#png("/home/st-analysis_home/franziska.hildebra/analysis/res/plots/cluster5_tissue.png", res = 300, units= "cm", width = 10, height = 20)
ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 5, spots = rownames(subset(se.pb[[]], seurat_clusters == c(5))))
#dev.off

ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = control, spots = rownames(subset(se.pb[[]], seurat_clusters == c(5))))

ST.FeaturePlot(se.pb, features = "seurat_clusters", ncol = 6, indices = control)                                                                                                                        

ST.FeaturePlot(se.pb, features = c("Stat1"), indices = 5)

ST.FeaturePlot(se.pb, features = deg9$gene[1:25], indices = 1, grid.ncol = 4)

FeatureOverlay(se.pb, features = "seurat_clusters",sampleids = infs[24], spots = rownames(subset(se.pb[[]], seurat_clusters == c(9))), ncols = 1)

FeatureOverlay(se.pb, features = c("Glul", "Sds", "HSP70-pb"),sampleids = 10, ncols = 1, blend = T)

FeatureOverlay(se.pb, features = c("Pb_Features1"),sampleids = 2, ncols = 1)


ST.FeaturePlot(se.pb, features = "nCount_pb", indices = infs, ncol = 5)
...
```{r, include the images to the analysis}


se.inf <- SubsetSTData(se.pb, infection == "infected")

ST.FeaturePlot(se.inf, features = "seurat_clusters", ncol = 5)
FeatureOverlay(se.inf, features = "nCount_pb", sampleids = 7)

ST.FeaturePlot(se.inf, features = "seurat_clusters", ncol = 5, spots = which(se.inf$seurat_clusters %in% c(0,1,3,4)))
ST.FeaturePlot(se.inf, features = "seurat_clusters", ncol = 5, spots = which(se.inf$seurat_clusters %in% c(10)))
ST.FeaturePlot(se.inf, features = "seurat_clusters", ncol = 5, spots = which(se.inf$seurat_clusters %in% c(11)))

ST.FeaturePlot(se.pb, features = c("Glul", "Sds", "Saa2", "Hspa1b"), ncol = 5)

ST.FeaturePlot(se.pb, features = c("Glul", "Sds", "Saa2", "Hspa1b"), ncol = 5)


ST.FeaturePlot(se.pb, features = "timepoint", ncol = 5)


ST.FeaturePlot(se.pb, features = deg5$gene[c(4:8)], ncol = 5)


ST.FeaturePlot(se.pb, features = deg2$gene[3:5], ncol = 6, indices = c(35,36))
...
deg12h <- FindMarkers(se.pb, ident.1 = "12h infected", ident.2 = c("24h infected", "38h infected", "38h control","24h control", "12h control"), logfc.threshold = 0.5, only.pos = T)

deg24h <- FindMarkers(se.pb, ident.1 = "24h infected", ident.2 = c("12h infected","38h infected", "38h control","24h control", "12h control"), logfc.threshold = 0.5, only.pos = T) #the majority of these genes are different because they are regulated by the circadian rythm which is why we dom't want to consider this kind of analysis but only look at differences between 24h infection vs controls

deg38h <- FindMarkers(se.pb, ident.1 = "38h infected", ident.2 = c("24h infected", "12h infected", "12h control","24h control", "38h control"), logfc.threshold = 0.5, only.pos = T)
...
deg38h_inf <- FindMarkers(se.pb, ident.1 = "38h infected", ident.2 =  "38h control", only.pos = T,logfc.threshold = 0.5)
deg38h_inf <- subset(deg38h_inf, deg38h_inf$p_val_adj < 0.01)
...
pdf(paste0(repo,"/res/RNA_count_zones.pdf", height = 5, width = 8))
...
pdf(paste0(repo,"/res/frequency_parasite+_vein_proximity.pdf", width = 5, height =3))
...
Now that we have validated parasite regions which we have previously manually annotated we can continue to investigate whether we can find host genes that are differentially expressed between parasite infected locations and the remaining tissue. We can then follow their expression gradients as a function to the distance to a parasite. 
...
write.table(pb_12deg,  paste0(repo, "res/tables_supplementary_data/pb_12h_deg.csv", sep = ",", quote = F, row.names = F, col.names = colnames(pb_12deg)))
...
write.table(pb_24deg,  paste0(repo, "res/tables_supplementary_data/pb_24h_deg.csv", sep = ",", quote = F, row.names = F, col.names = colnames(pb_24deg)))
...
write.table(pb_38deg, paste0(repo, "res/tables_supplementary_data/pb_38h_deg.csv", sep = ",", quote = F, row.names = F, col.names = colnames(pb_38deg)))


Reduce(intersect, list(pb_12deg$gene, pb_24deg$gene, pb_38deg$gene))
...
```{r, correlation clusters}

pdf(paste0(repo, "res/plots/figures/supplementary/VlnPlot_DEG_38h_ISG_clusters.pdf", width = 8, height = 3))
VlnPlot(se.pb, features = "DEG_inf_38h1", group.by = "seurat_clusters", cols = clust.cols, sort = F)
dev.off()

df_c_expr <- data.frame(cluster = se.pb$seurat_clusters, DEG_inf_38h = se.pb$DEG_inf_38h1)

df_agg <- aggregate(DEG_inf_38h ~ cluster, data = df_c_expr , FUN = function(x) cbind(mean = mean(x), sd = sd(x)))
df_agg <- data.frame(cluster = df_agg$cluster, mean_expression = df_agg$DEG_inf_38h[,1], sd_expression = df_agg$DEG_inf_38h[,2])
library(stats)

ggplot(df_agg, aes(x = cluster, y = mean_expression, fill = cluster)) +
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin = mean_expression - sd_expression, ymax = mean_expression + sd_expression), width = 0.2) +
  scale_fill_manual(values = clust.cols)+
  labs(x = "Cluster", y = "Mean Expression") +
  theme_classic()

pdf(paste0(repo, "res/plots/figures/supplementary/VlnPlot_DEG_12h_ISG_clusters.pdf", width = 20, height = 10))
VlnPlot(se.pb, features = "DEG_inf_12h1", group.by = "seurat_clusters", cols = clust.cols, sort = F)
dev.off()

df_c_expr <- data.frame(cluster = se.pb$seurat_clusters, DEG_inf_12h = se.pb$DEG_inf_12h1)
df_agg <- aggregate(DEG_inf_12h ~ cluster, data = df_c_expr , FUN = function(x) cbind(mean = mean(x), sd = sd(x)))
df_agg <- data.frame(cluster = df_agg$cluster, mean_expression = df_agg$DEG_inf_12h[,1], sd_expression = df_agg$DEG_inf_12h[,2])
library(stats)
...
```{r, differential host gene expression in infected versus non-infected tissue areas, fig.width= 8, fig.height= 8}


se.parasite <- SubsetSTData(se.pb, expression = infection == "infected")
#Use default settings first
se.parasite <- SetIdent(se.parasite, value = "timepoint")
parasite_time_deg <- FindAllMarkers(se.parasite, only.pos = T, logfc.threshold = 0.5)
parasite_time_deg <- subset(parasite_time_deg, parasite_time_deg$p_val < 0.01)

##Visualize markers for infected positions across timepoints: 
se.parasite$timepoint_parasite <- as.factor(paste0(se.parasite$timepoint, "_", se.parasite$parasite_n))
se.parasite <- SetIdent(se.parasite, value = "parasite_timepoint")
inf_deg <- FindAllMarkers(se.parasite, only.pos = T) #create a column with conditions of interest
inf_deg <- subset(parasite_time_deg, p_val_adj < 0.01 & avg_log2FC > 1)
#make an aggregated heatmap: 
parasite_time_mat <- hmat_pb(t(se.pb@assays$SCT@counts), meta = se.pb$condition)
parasite_time_mat <- parasite_time_mat[, c("12h control", "24h control", "38h control", "12h infected", "24h infected", "38h infected")]

pdf(paste0(repo, "res/res/DEG_timepoints_infection_38h.pdf", width = 20, height = 10))
phmat_simple(parasite_time_mat, seed = c(unique_pb_t[[3]]))
dev.off()


pdf(paste0(repo, "res/DEG_timepoints_infection_12h.pdf", width = 20, height = 10))
phmat_simple(parasite_time_mat, seed = c(unique_pb_t[[1]]))
dev.off()

pdf(paste0(repo, "res/DEG_timepoints_infection_unique_all.pdf", width = 20, height = 30))
phmat_simple(parasite_time_mat, seed = c(unique_pb_t[[1]], unique_pb_t[[2]], unique_pb_t[[3]]))
dev.off()
...
##Check enrichment of genes: 

golysis.tree(names(clusters_dend_12h_inf), source = "KEGG", nterms = 5, significant = T)
golysis.tree(names(clusters_dend_24h_inf), source = "KEGG", nterms = 5, significant = F)
golysis.tree(names(clusters_dend_38h_inf), source = "KEGG", nterms = 5, significant = T)
...
```{r, define hotspots of high module expression and visualize them}

##Take the highest quantile for each condition but focus especially on 12h p.i. 

summary(se.12h$DEG_inf_12h1)
summary(se.24h$DEG_inf_24h1)
summary(se.12h$DEG_inf_12h1)

#select spots above the 99% percentile to annotate them as "DEG_X_high" and everything below as "DEG_X_low"

percentile_12h <- quantile(se.12h$DEG_inf_12h1, 0.90) #get the very high values by even including the 9.9 percentile only as "high" values
percentile_24h <- quantile(se.24h$DEG_inf_24h1, 0.90)
percentile_38h <- quantile(se.38h$DEG_inf_38h1, 0.90)


se.12h$DEG_inf_12h_annotation <- ifelse(se.12h$DEG_inf_12h1 > percentile_12h, paste0("DEG_12h_high"), paste0("DEG_12h_low"))

se.24h$DEG_inf_24h_annotation <- ifelse(se.24h$DEG_inf_24h1 > percentile_24h, paste0("DEG_24h_high"), paste0("DEG_24h_low"))

se.38h$DEG_inf_38h_annotation <- ifelse(se.38h$DEG_inf_12h1 > percentile_38h, paste0("DEG_38h_high"), paste0("DEG_38h_low"))

#central vs. portal 

##make dataframe with distances and DEG annotations

df <- data.frame(portal = se.12h$dist_portal_um, central = se.12h$dist_central_um, parasite = se.12h$dist_parasite_um, IHS = se.12h$dist_roi_um, ann = se.12h$DEG_inf_12h_annotation)
df <- df[df$parasite < 1000,]

#parasite distance 
ggplot(df, aes(x = ann, y = parasite)) + 
         geom_boxplot() + 
        scale_x_discrete(limits = c("DEG_12h_low", "DEG_12h_high"))
#Run a statistical test 
##Kruskal-wallis

kw_test <- kruskal.test(parasite ~ ann, data = df)
##No significant difference in expression of these genes in regards to proximity to the parasite

#Pb count in these areas 

#Make dataframe with Pb_count and annotation 

df_cnt_pb <- data.frame(count = se.12h$nCount_pb, ann = se.12h$DEG_inf_12h_annotation)
#remove 0s to see if there is a decrease in general
df_cnt_pb <- df_cnt_pb[df_cnt_pb$count > 0,]
ggplot(df_cnt_pb, aes(x = ann, y = log10(count))) + 
  geom_boxplot()


df_cnt_pb <- data.frame(count = se.24h$nCount_pb, ann = se.24h$DEG_inf_24h_annotation)
#remove 0s to see if there is a decrease in general
df_cnt_pb <- df_cnt_pb[df_cnt_pb$count > 0,]
ggplot(df_cnt_pb, aes(x = ann, y = log10(count))) + 
  geom_boxplot()

df_cnt_pb <- data.frame(count = se.38h$nCount_pb, ann = se.38h$DEG_inf_38h_annotation)
#remove 0s to see if there is a decrease in general
df_cnt_pb <- df_cnt_pb[df_cnt_pb$count > 0,]
ggplot(df_cnt_pb, aes(x = ann, y = log10(count))) + 
  geom_boxplot()
...
##Observed difference here is also non-significant 

```

Now let's check how the gene expression of these looks like when compared to the parasite positions 

```{r, visualize heterogeneity for parasites}
##We manually annotated parasite positions for all parasites 
#First we subset the data sp they only include parasite annotated positions
se.12h <- SubsetSTData(se.12h, expression = parasite_ann != "Default")
se.24h <- SubsetSTData(se.24h, expression = parasite_ann != "Default")
se.38h <- SubsetSTData(se.38h, expression = parasite_ann != "Default")

se.12h <- SubsetSTData(se.12h, expression = parasite_ann != "parasite")
se.24h <- SubsetSTData(se.24h, expression = parasite_ann != "parasite")
se.38h <- SubsetSTData(se.38h, expression = parasite_ann != "parasite_380")

#remove 263, 264 and 120 adnd 380 from se.38h as they only have one datapoint
pdf(paste0(repo, "res/variable_expression_parasite_positions_12h.pdf", height = 10, width = 7))
VlnPlot(se.12h, "DEG_inf_12h1", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(158)) + theme(legend.position = 'none') + coord_flip()
dev.off()
#VlnPlot(se.24h, "DEG_inf_24h1", group.by = "parasite_ann", sort = T) + theme(legend.position = 'none') not enough unique genes for 24h timepoint

pdf(paste0(repo, "res/variable_expression_parasite_positions_38h.pdf", height = 10, width = 7))
VlnPlot(se.38h, "DEG_inf_38h1", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(158)) + theme(legend.position = 'none') +
  coord_flip()
dev.off()

#Check for the 24h timepoint 
VlnPlot(se.12h, c("DEG_inf_12h1"), group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')
VlnPlot(se.12h, c("dist_comp_ann_central_um"), group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')
VlnPlot(se.12h, c("dist_comp_ann_portal_um"), group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')

VlnPlot(se.24h, c("DEG_inf_12h1"), group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')


VlnPlot(se.24h, c("DEG_inf_12h1"), group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')

##Also check for specific genes of interest

VlnPlot(se.12h, "Cxcl10", group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')
VlnPlot(se.24h, "Cxcl10", group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')
VlnPlot(se.12h, "Cxcl10", group.by = "parasite_ann", sort = T) + theme(legend.position = 'none')


VlnPlot(se.38h, c("Ifih1", "Ifit1", "Irf7", "Irf9"), group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')

```

```{r, make RIG-I module}
#make modules from cluster 10 and 11 expression and look at parasites 

se.pb <- AddModuleScore(se.pb, features = list(deg10$gene), name = "deg_ST11")
se.pb <- AddModuleScore(se.pb, features = list(deg9$gene), name = "deg_ST10")

VlnPlot(se.38h, "deg_ST111", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')
VlnPlot(se.38h, "deg_ST101", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')


VlnPlot(se.24h, "deg_ST111", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')
VlnPlot(se.24h, "deg_ST101", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')


VlnPlot(se.12h, "deg_ST111", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')
VlnPlot(se.12h, "deg_ST101", group.by = "parasite_ann", sort = T, cols = colorRampPalette(rev(c("#660156","#21908C", "#FFF68F", "#FFD700")))(159)) + theme(legend.position = 'none')

ST.FeaturePlot("")
```

```{r, check which f se.12h has fewer than 2 datapoints and drop it} 

df <- data.frame(modulescore = se.38h$DEG_inf_38h1, parasite_ann = se.38h$parasite_ann)

table(df$parasite_ann)

#remove 263, 264 and 120 from se.12h as they only have one datapoint
...
pdf(paste0(repo, "res/raincloud_parasite_portal.pdf"))
...
pdf(paste0(repo, "res/raincloud_parasite_central.pdf"))
...
summary(se.12h$DEG_inf_12h1)
#Now we define all spots above and below the median and within 200µm of the parasite position for each timepoint 
##First we subset our data to contain only spots within 200 µm of a parasite (That we already have as the parasite_n column)
...
(1) see whether this expression differs based on the time point of infection

(2) find any additional genes that are correlated with the positions which are infected with parasites.

(3) In addition we can check whether the parasite positive positions are more likely to locate within specific clusters in the data (e.g in portal or central clusters)

(4) and investigate whether the parasite positive positions can be defined further based on gene expression profiles of the host or the parasite (clustering of data)


##(1) gene expression along the time axis in infected samples


Now we can actually look at gene expression in infected positions over time using aggregated expression profiles 

```{r,Follow gene expression over time (show in heatmap)}

se.inf$pb_tp <- paste0(se.inf$parasite_n," ",se.inf$timepoint)

inf_p_mat <- hmat_pb(t(se.inf@assays$SCT@counts), meta = se.inf$parasite_n)
inf_p_t_mat <- hmat_pb(t(se.inf@assays$SCT@counts), meta = se.inf$parasite_timepoint)
  
  
phmat_simple(inf_p_mat, c( pb_12deg$gene, pb_24deg$gene, pb_12deg$gene))
phmat_simple(inf_c_mat, c( pb_12deg$gene, pb_24deg$gene, pb_12deg$gene))

#Now we want to group the genes by timepoint association as well 
#make annotation rows for the heatmap: 
annotation_row = data.frame(
  GeneClass = factor(rep(c("12h p.i.", "24h p.i.", "12h p.i."), c(length(pb_12deg$gene), length(pb_24deg$gene), length(pb_12deg$gene)))), 
  Gene = c(pb_12deg$gene,pb_24deg$gene, pb_12deg$gene))
rownames(annotation_row) = make.unique(c(rownames(pb_12deg), rownames(pb_24deg), rownames(pb_12deg)))
annotation_row <- annotation_row[!duplicated(annotation_row[c("Gene")]), ]
annotation_row$Gene <- NULL
#Run the same analysis for non-infected positions (with the same set of genes)
inf_c_mat <- hmat_pb(t(se.remain@assays$SCT@counts), meta = se.remain$timepoint)

phmat_simple(inf_p_mat, c(pb_12deg$gene,
                          pb_24deg$gene,
                          pb_24deg$gene
                          ))
phmat_simple(inf_c_mat, c(pb_12deg$gene,pb_24deg$gene,pb_12deg$gene))

#Look at genes identified to be differentially expressed between a.l parasite containing positions compared to the remaining postions
#pdf("/home/st-analysis_home/franziska.hildebra/analysis/res/plots/deg_parasite_default.pdf")
phmat_simple(inf_p_mat, inf_marker$gene)
#dev.off()


phmat_simple(inf_c_mat, inf_marker$gene)

##Possibly think about a way to show differences in gene expression over time in a better way 
#Potentially using density plots for a selecton of genes 

###It seems the majority of differential expression of host genes in infected parasite spots is driven by differential gene expression in the 24h timepoint 

##We can check for differential expression between parasite + timepoint 

se.pb$parasite_timepoint <- paste0(se.pb$parasite, " ", se.pb$timepoint)
se.pb <- SetIdent(se.pb, value = "parasite_timepoint")

#Use default settings first
parasite_deg_t <- FindAllMarkers(se.pb, only.pos = T)

parasite_deg_t <- subset(parasite_deg_t, parasite_deg_t$p_val_adj < 0.05 & parasite_deg_t$avg_log2FC >= 0.5)




phmat_simple(inf_p_mat, parasite_deg_t[parasite_deg_t$cluster == c("parasite 12h"),]$gene
             )
...
## (4) Now we are assuming that all parasites in infected positions are equally "successful" but we want to check if there might be obvious differences in parasite posistions to possibly distinguish "successful" from dead or less successful parasites. 


This shows that the biggest difference between parasites is based on the biological replicate/sample - perhaps one could try to look in more detail into batch correction and how to perform this in a way so the noise from bioreps disappears. 
...
pdf(paste0(repo, "res/percentage_clusters_condition.pdf"))
